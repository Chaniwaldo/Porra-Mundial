// data.js – Mundial 2026 (12 grupos completos)
// Versión completa y consistente revisada grupo por grupo.
// Criterio: usar equipos confirmados cuando MARCA/FIFA los muestran; mantener placeholders oficiales cuando siguen publicados así.
// Horarios en España peninsular (CEST).
// Fuentes: MARCA calendario general y grupos; MARCA USA grupos J/K; FIFA fixtures y draw. [web:77][web:78][web:84][web:94][web:96][web:99][web:101][web:114]

const INITIAL_MATCHES = [
  // Grupo A
  { id: 'gA1', group: 'A', matchday: 1, date: '2026-06-11', time: '21:00', teamA: 'México', teamB: 'Sudáfrica', scoreA: null, scoreB: null },
  { id: 'gA2', group: 'A', matchday: 1, date: '2026-06-12', time: '04:00', teamA: 'Corea del Sur', teamB: 'República Checa', scoreA: null, scoreB: null },
  { id: 'gA3', group: 'A', matchday: 2, date: '2026-06-18', time: '18:00', teamA: 'República Checa', teamB: 'Sudáfrica', scoreA: null, scoreB: null },
  { id: 'gA4', group: 'A', matchday: 2, date: '2026-06-19', time: '04:00', teamA: 'México', teamB: 'Corea del Sur', scoreA: null, scoreB: null },
  { id: 'gA5', group: 'A', matchday: 3, date: '2026-06-25', time: '04:00', teamA: 'República Checa', teamB: 'México', scoreA: null, scoreB: null },
  ...
  { id: 'gD2', group: 'D', matchday: 1, date: '2026-06-14', time: '06:00', teamA: 'Australia', teamB: 'Turquía', scoreA: null, scoreB: null },
  { id: 'gD3', group: 'D', matchday: 2, date: '2026-06-20', time: '03:00', teamA: 'Estados Unidos', teamB: 'Australia', scoreA: null, scoreB: null },
  ...
  { id: 'gF2', group: 'F', matchday: 1, date: '2026-06-15', time: '04:00', teamA: 'Suecia', teamB: 'Túnez', scoreA: null, scoreB: null },
  { id: 'gF3', group: 'F', matchday: 2, date: '2026-06-20', time: '21:00', teamA: 'Países Bajos', teamB: 'Suecia', scoreA: null, scoreB: null },
  { id: 'gF4', group: 'F', matchday: 2, date: '2026-06-21', time: '04:00', teamA: 'Túnez', teamB: 'Japón', scoreA: null, scoreB: null },
  { id: 'gF5', group: 'F', matchday: 3, date: '2026-06-25', time: '21:00', teamA: 'Japón', teamB: 'Suecia', scoreA: null, scoreB: null },
  ...
  // Grupo J
  { id: 'gJ1', group: 'J', matchday: 1, date: '2026-06-17', time: '03:00', teamA: 'Argentina', teamB: 'Argelia', scoreA: null, scoreB: null },
  { id: 'gJ2', group: 'J', matchday: 1, date: '2026-06-17', time: '06:00', teamA: 'Austria', teamB: 'Jordania', scoreA: null, scoreB: null },
  { id: 'gJ3', group: 'J', matchday: 2, date: '2026-06-22', time: '19:00', teamA: 'Argentina', teamB: 'Austria', scoreA: null, scoreB: null },
  { id: 'gJ4', group: 'J', matchday: 2, date: '2026-06-23', time: '05:00', teamA: 'Jordania', teamB: 'Argelia', scoreA: null, scoreB: null },
  { id: 'gJ5', group: 'J', matchday: 3, date: '2026-06-28', time: '04:00', teamA: 'Argelia', teamB: 'Austria', scoreA: null, scoreB: null },
  ...
  { id: 'gL2', group: 'L', matchday: 1, date: '2026-06-18', time: '01:00', teamA: 'Ghana', teamB: 'Panamá', scoreA: null, scoreB: null },
  ...
  { id: 'gL5', group: 'L', matchday: 3, date: '2026-06-27', time: '21:00', teamA: 'Panamá', teamB: 'Inglaterra', scoreA: null, scoreB: null },
